                    ...
                    return (
                      <div key={idx} className="flex justify-between items-center py-2.5 text-xs first:pt-0 last:pb-0">
                        <span className="text-slate-600 font-medium">
                          {svc.nameProduct || 'Dịch vụ'} <strong className="text-emerald-800 font-extrabold ml-1 bg-emerald-50 border border-emerald-100/30 px-1.5 py-0.5 rounded-md">x{bs.quantity}</strong>
                        </span>
