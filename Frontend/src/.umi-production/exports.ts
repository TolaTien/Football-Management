...
// plugins
export { Access, useAccess, useAccessMarkedRoutes } from 'D:/PTIT/TH_Laptrinhweb/Football-Management/Frontend/src/.umi-production/plugin-access';
export { Provider, useModel } from 'D:/PTIT/TH_Laptrinhweb/Football-Management/Frontend/src/.umi-production/plugin-model';
export { useRequest, UseRequestProvider, request, getRequestInstance } from 'D:/PTIT/TH_Laptrinhweb/Football-Management/Frontend/src/.umi-production/plugin-request';
// plugins types.d.ts
export * from 'D:/PTIT/TH_Laptrinhweb/Football-Management/Frontend/src/.umi-production/plugin-access/types.d';
export * from 'D:/PTIT/TH_Laptrinhweb/Football-Management/Frontend/src/.umi-production/plugin-antd/types.d';
export * from 'D:/PTIT/TH_Laptrinhweb/Football-Management/Frontend/src/.umi-production/plugin-request/types.d';
// @umijs/renderer-*
